...
## 프로젝트 링크
 > AWS EC2로 서버 구축 및 RDS로 Oracle DB와 연동하였습니다. < *보완 작업 중입니다. >
 
 > 직접 회원가입을 하거나 소셜 연동으로 로그인하여 사이트를 이용할 수 있지만,
 편의를 위해 아래의 예시 아이디를 사용하셔도 됩니다.
```
             (아이디 / 비밀번호)
회원 : yeji12345 / 12345abc!
관리자 : lee12345 / 12345abc!
```   
