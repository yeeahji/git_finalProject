...
<div align="center">아나바다 마켓은 웹이라는 공간에서 보다 편리하게 중고물품을 거래할 수 있습니다.
...
사이트 [번개장터](https://m.bunjang.co.kr/)에서 UI와 전반적인 기능을, [당근마켓](https://www.daangn.com/)에서 에코지수(당근마켓의 매너온도)와 거래 성사 과정을 벤치마킹하였습니다.</div>
<br/><br/><br/>
